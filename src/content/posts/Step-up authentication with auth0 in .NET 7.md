---
title: Step-up authentication with Auth0 in .NET 7
...
shareImage: /images/stepup/small-step-up authentication.jpg
codeMaxLines: 10
...
<figure class="post-figure center nocaption fancybox">
  <img src="/images/stepup/step-up-auth-flow.jpg" alt="step-up-auth-flow" loading="lazy" />
...
<div class="code-title">AMR contains mfa</div>
...
<div class="code-title">Enable MFA Rule</div>

```js
function(user, context, callback) {ff
...
<div class="code-title">TransferMoney.razor</div>
...
<div class="code-title">NavigationManagerExtensions.cs</div>
