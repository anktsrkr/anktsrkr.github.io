...
date: 2025-05-23T18:00:00.000Z
description: How to use Semantic Kernel in AI development using Ollama / OpenAI using C#
featured: true
draft: false
toc: false
thumbnailImage: /images/semantic-kernel/ollama.png
thumbnailImagePosition: left
shareImage: /images/semantic-kernel/ollama.png
codeMaxLines: 10
...
<div class="code-title">SemanticChat.Ollama.csproj</div>
...
<figure class="post-figure center nocaption fancybox">
  <img src="/images/semantic-kernel/ollama.gif" alt="ollama" loading="lazy" />
...
<aside class="callout callout-danger callout-danger callout-no-icon">
<p>Now, Ollama supports streaming with function call since v0.8.0. More information can be found <a href="https://ollama.com/blog/streaming-tools">here</a>.</p>
</aside>



Next post will talk about **<span class="hl hl-cyan">LM Studio</span>**. We will see how to use it with Semantic Kernel and build a chat application.



<aside class="callout callout-info callout-info callout-no-icon">
<p>Ollama Icon used in this post is property of <a href="https://ollama.com/">Ollama</a>.</p>
</aside>
