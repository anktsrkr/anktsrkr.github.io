...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/weather-api.png" alt="Weather API" loading="lazy" />
  <figcaption>Weather API</figcaption>
</figure>
...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/console-startup.png" alt="Console Startup" loading="lazy" />
  <figcaption>Console Startup</figcaption>
</figure>
...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/weatherforecast-client.png" alt="Weather API" loading="lazy" />
  <figcaption>Weather API</figcaption>
</figure>
...
<figure class="post-figure right clear">
  <img src="/images/pollynet8/sequence.png" alt="HttpClient Retry Resilience Strategy" loading="lazy" />
  <figcaption>HttpClient Retry Resilience Strategy</figcaption>
</figure>
...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/console-required-packages.png" alt="Required Packages for Console App" loading="lazy" />
  <figcaption>Required Packages for Console App</figcaption>
</figure>
...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/console-startup-with-retry.png" alt="HttpClientFactory Extension Method" loading="lazy" />
  <figcaption>HttpClientFactory Extension Method</figcaption>
</figure>
...
<figure class="post-figure fancybox right clear">
  <img src="/images/pollynet8/console-retry.png" alt="Console Retry" loading="lazy" />
  <figcaption>Console Retry</figcaption>
</figure>
