...
date: 2025-05-14T05:00:00.000Z
description: How to use Semantic Kernel in AI development
featured: true
draft: false
toc: false
thumbnailImage: /images/semantic-kernel/sk.png
thumbnailImagePosition: left
shareImage: /images/semantic-kernel/sk.png
codeMaxLines: 10
...
With this post, I am starting a new series about **<span class="hl hl-cyan">Semantic Kernel</span>**. Over the time, I will updated this page with links to individual posts : 
...
At the highest level, <span class="hl hl-blue">Generative AI</span> (GenAI) is a subset of artificial intelligence that focuses on creating new content, such as text, images, music, and more. Below is a simple diagram that illustrates the relationship between artificial intelligence and Generative AI: 



<figure class="post-figure center nocaption fancybox">
  <img src="/images/semantic-kernel/gen_ai.svg" alt="Gen AI" loading="lazy" />
...
- **Deep Learning (DL)**
A subset of machine learning that uses <span class="hl hl-green">artificial neural networks</span> with many layers to analyze various factors of data. 

<span class="hl hl-blue">Generative AI</span>is built upon a specific type of AI model, called a **<span class="hl hl-yellow">Generative Model</span>**.  These models mathematically approximate the distribution of the training data. These models take large amounts of data as input such as text, images etc., In second phase, a deep learning model is utilized to recognize patterns within the data. Finally, the model generates new content based on the learned patterns.
...
<figure class="post-figure center nocaption fancybox">
  <img src="/images/semantic-kernel/llm_fm.svg" alt="LLM &amp; FM" loading="lazy" />
