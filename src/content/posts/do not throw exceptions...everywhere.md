---
title: Do not throw exceptions...Everywhere
date: 2023-10-08T07:00:35.000Z
description: 'Do not throw exceptions...Everywhere, Instead make it as rule.'
featured: true
draft: false
toc: false
thumbnailImage: /images/exception/small-rulevsexception.png
shareImage: /images/exception/small-rulevsexception.png
codeMaxLines: 10
...
<div class="code-title">UserService.cs</div>
...
<div class="code-title">UserController.cs</div>
...
```csharp
public async Task<ProblemOr<Success>> SendEmailAsync(string email)
{
