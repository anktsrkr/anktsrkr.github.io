...
I am currently building and writing around practical agentic AI for .NET developers, with a focus on patterns that can move from local experimentation to enterprise use. A major part of that work is around the [Microsoft Agent Framework](https://microsoft-agent-framework.github.io/), where I contribute tutorial content and examples that explain agents, tools, memory, workflows, state, checkpoints and hosting patterns in a way that working engineers can apply.
...
- [microsoft-agent-framework/microsoft-agent-framework.github.io](https://github.com/microsoft-agent-framework/microsoft-agent-framework.github.io) - Microsoft Agent Framework site and tutorial content.
- [anktsrkr/scrapegraphai-csharp-sdk](https://github.com/anktsrkr/scrapegraphai-csharp-sdk) - a C# SDK and Agent Framework integration for ScrapeGraphAI.
- [anktsrkr/linkup-csharp-sdk](https://github.com/anktsrkr/linkup-csharp-sdk) - a C# SDK for Linkup.

## Selected Open Source Contributions

When time allows, I contribute to open-source projects in the .NET ecosystem:

- [Ocelot](https://github.com/ThreeMammals/Ocelot) - an API gateway for .NET and ASP.NET Core applications. I have been involved as an organization member of ThreeMammals, the organization behind Ocelot.
- [Elsa Workflows](https://github.com/elsa-workflows/elsa-core) - a workflows library for .NET applications. I contributed distributed lock providers based on [Azure Blob Storage](https://github.com/elsa-workflows/elsa-core/pull/332) and [Redis](https://github.com/elsa-workflows/elsa-core/pull/330).
- [AspNetCoreCertificates](https://github.com/damienbod/AspNetCoreCertificates) - a package for creating certificates for client/server authentication and IoT scenarios. I contributed to common OID support.

## Certifications And Badges

I keep my certifications current across cloud architecture, Azure engineering, DevOps, AI and GitHub platform capabilities. Microsoft certifications can be verified through my [Microsoft Learn transcript](https://learn.microsoft.com/en-us/users/ankitsarkar/transcript/vn0qmu4wl2xgwye), while GitHub badges are available through my [Credly profile](https://www.credly.com/users/sarkaran/badges).
