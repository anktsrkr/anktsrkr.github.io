---
title: "Building Smart Agents with LM Studio: A Complete Walkthrough of the Microsoft Agent Framework and /v1/responses API" # Title of the blog post.
date: 2025-10-09T05:00:00+01:00 # Date of post creation.
description: "Build smart agents in LM Studio with the new /v1/responses API and Microsoft Agent Framework—master previous_response_id for seamless conversations & remote tool use." # Description used for search engine.
...
shareImage: "/images/agent-framework/aflogo.png" # Designate a separate image for social media sharing.
...
{{< image classes="center nocaption fancybox" src="/images/agent-framework/lmstudio-responseapi.gif" title="lmstudio-in-action" >}}
...
[openai/openai-dotnet#748](https://github.com/openai/openai-dotnet/issues/748)
{{< /alert >}}
